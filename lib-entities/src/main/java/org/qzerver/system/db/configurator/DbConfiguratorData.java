...
public final class DbConfiguratorData {
    ...
    public static final Map<DbConfiguratorType,String> HIBERNATE_DIALECTS = ImmutableMap.<DbConfiguratorType,String>builder()
    ...
    public static final Map<DbConfiguratorType,String> QUARTZ_ADAPTERS = ImmutableMap.<DbConfiguratorType,String>builder()
    ...
    public static final Map<DbConfiguratorType,String> JDBC_DRIVERS = ImmutableMap.<DbConfiguratorType,String>builder()
    ...
    public static final Map<DbConfiguratorType,String> TEST_SQL_QUERIES = ImmutableMap.<DbConfiguratorType,String>builder()
    ...
    public static final Map<DbConfiguratorType,Boolean> HIBERNATE_NEW_GENERATORS = ImmutableMap.<DbConfiguratorType,Boolean>builder()
