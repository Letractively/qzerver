...
[#-- Output HTML-attribute dictionary
 * attrs - attribute dictionary
--]
[#macro outputAttributes attrs][#list attrs?keys as key]${key?html}="${attrs[key]?html}"[#if key_has_next] [/#if][/#list][/#macro]

[#-- Output class list as a string
 * classes - class list
--]
[#macro outputClasses classes][#if classes?has_content]class="[#list classes as class]${class?html}[#if class_has_next] [/#if][/#list]"[/#if][/#macro]
